...
assert len(ta_lines) == len(en_lines)
...
preds = translate_batch_nllb(ta_lines)
...
refs_norm = [normalize_text(r) for r in en_lines]
...
df.to_csv(
    "nllb_results_ta2en_fast.csv",
    index=False,
    encoding="utf-8-sig"
)

print("Saved: nllb_results_ta2en_fast.csv")
