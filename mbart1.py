...
def translate_mbart(text, src_lang="ta_IN", tgt_lang="en_XX"):
    ...
    # Set target language token id
    tgt_lang_token_id = tokenizer.lang_code_to_id[tgt_lang]
...
run_translation("ta", "en", "ta_IN", "en_XX", "mbart_results_ta2en.csv")
run_translation("en", "ta", "en_XX", "ta_IN", "mbart_results_en2ta.csv")
