...
sources = test_ds["targetText"]   # English
references = test_ds["sourceText"]  # Tamil
...
df.to_csv(
    "nllb_ntrex_en2ta_optimized.csv",
    index=False,
    encoding="utf-8-sig"
)

print("Saved: nllb_ntrex_en2ta_optimized.csv")
